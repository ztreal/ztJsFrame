...
(function($) {
    $.flexbox = function(div, o) {
        ...
        var $ctr = $('<div></div>')
			...
			//MODIFY BY ZHANG TAN 修改位置  原是top+2 获取外围高度有问题
            .css('top', 22)
            .css('left', 0)
    ...
    $.fn.flexbox.defaults = {
        ...
        noResultsText: '没找到', // text to show when no results match the query
        ...
        paging: {
            ...
            //modify by zhangtan 修改显示文字
            summaryTemplate: '共{total}条结果   显示第{start}-{end}条  ' // can use {page} and {pages} as well
        }
    };
